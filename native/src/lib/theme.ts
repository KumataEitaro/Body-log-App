...
function derivePalette(accent: string): Palette {
  ...
  return {
    ...
    pressed: mixW(accent, 0.94), calorieBar: '#3f4c5a', hairline: 'rgba(14,17,22,0.08)', shadow: '#0e1116', coral: '#e5484d', coralWeak: '#fdeeec', amber: '#b8860b',
  };
}
...
export const PALETTES: Record<AccentKey, Palette> = {
  green: {
    ...
    pressed: '#f1f3f0', calorieBar: '#3f4c5a', hairline: 'rgba(14,17,22,0.08)', shadow: '#0e1116', coral: '#e5484d', coralWeak: '#fdeeec', amber: '#b8860b',
  },
  blue: {
    ...
    pressed: '#eef2f7', calorieBar: '#475569', hairline: 'rgba(14,17,22,0.08)', shadow: '#0e1116', coral: '#e5484d', coralWeak: '#fdeceb', amber: '#b07d0a',
  },
  purple: {
    ...
    pressed: '#f2eef6', calorieBar: '#4a4257', hairline: 'rgba(14,17,22,0.08)', shadow: '#0e1116', coral: '#e5484d', coralWeak: '#fceced', amber: '#a9790f',
  },
  orange: {
    ...
    pressed: '#f5f0eb', calorieBar: '#5a4a3f', hairline: 'rgba(14,17,22,0.08)', shadow: '#0e1116', coral: '#e5484d', coralWeak: '#fceae7', amber: '#a97a12',
  },
  pink: {
    ...
    pressed: '#f5eef1', calorieBar: '#57424c', hairline: 'rgba(14,17,22,0.08)', shadow: '#0e1116', coral: '#e5484d', coralWeak: '#fceae9', amber: '#a97a12',
  },
  graphite: {
    ...
    pressed: '#f0f1f3', calorieBar: '#1e293b', hairline: 'rgba(14,17,22,0.08)', shadow: '#0e1116', coral: '#e5484d', coralWeak: '#fceceb', amber: '#a9800f',
  },
...
export function darkPaletteFor(accent: AccentKey): Palette {
  ...
  return {
    ...
    calorieBar: '#94a2b1', hairline: 'rgba(233,237,235,0.12)', shadow: '#000000',
