...
const STEPS = (): StepDef[] => [
  ...
  { kind: 'spot', route: '/training', target: 'trainInput', title: t('運動の記録'), text: t('犬の散歩でもOK。種類と時間を選ぶだけで消費カロリーに反映されます。筋トレの記録は同じページの下にあります。') },
  { kind: 'spot', route: '/changes', target: 'chart', title: t('変化を見る'), text: t('概要はメニューになっています。行をタップすると、体重や挙上重量の詳しいグラフがひらきます。') },
...
const s = StyleSheet.create({
  ...
  segT: { fontSize: 15, fontWeight: '700', color: C.sub },
