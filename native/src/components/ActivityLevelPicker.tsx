...
export const ACTIVITY_LEVELS = [
  { v: 1.2, t: 'ほぼ座って過ごす', d: 'デスクワーク中心。運動はほとんどしない' },
  { v: 1.375, t: '軽く動く', d: '通勤で歩く・立ち仕事・犬の散歩など。運動は週1〜2回' },
  { v: 1.55, t: 'よく動く', d: '週3〜5回は運動やスポーツをしている' },
  { v: 1.725, t: 'かなり動く', d: 'ほぼ毎日ハードに運動する・肉体労働' },
] as const;
