...
const s = themed(() => ({
  ...
  countBadgeT: { fontSize: 11, fontWeight: '800', color: C.accentInk },
  rec: {
    backgroundColor: C.accentSoft, borderWidth: 1.5, borderColor: C.accentBorder, borderRadius: 16,
    padding: 12, marginBottom: 10,
  },
  recLabel: { fontSize: 11, fontWeight: '800', color: C.accentInk, letterSpacing: 0.6 },
  ...
  recCta: { fontSize: 13, fontWeight: '800', color: C.accentInk, marginTop: 8, textAlign: 'right' },
  ...
  srcLink: { fontSize: 13, color: C.accentInk, lineHeight: 20, textDecorationLine: 'underline' },
}));
