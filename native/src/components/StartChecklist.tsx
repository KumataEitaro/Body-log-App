...
const s = StyleSheet.create({
  ...
  count: { fontSize: 13, fontWeight: '900', color: C.teal, fontVariant: ['tabular-nums'], marginRight: 4 },
  ...
  doneT: { fontSize: 13.5, fontWeight: '800', color: C.teal, lineHeight: 19, marginTop: 8, marginBottom: 2 },
