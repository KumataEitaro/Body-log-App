...
const s = StyleSheet.create({
  ...
  doneT: { color: '#fff', fontSize: 13, fontWeight: '800' },
  searchRow: {
  ...
  groupT: { fontSize: 11, fontWeight: '800', color: C.sub, marginTop: 14, marginBottom: 4, letterSpacing: 0.4 },
  ...
  note: { fontSize: 12.5, color: C.sub, marginTop: 20, lineHeight: 20 },
});
