...
const s = StyleSheet.create({
  ...
  sub: { fontSize: 11.5, color: C.sub, marginTop: 6, marginBottom: 12, lineHeight: 17 },
  row: {
  ...
  icon: { fontSize: 22 },
  rowT: { fontSize: 14.5, fontWeight: '700', color: C.ink, flexShrink: 1 },
  rowSub: { fontSize: 11.5, color: C.sub, marginTop: 3, lineHeight: 17 },
  arrow: { fontSize: 22, color: C.faint },
  tag: { borderRadius: 999, paddingHorizontal: 7, paddingVertical: 1.5 },
  tagT: { fontSize: 9.5, fontWeight: '800' },
  ...
  doneT: { fontSize: 16, fontWeight: '800', color: C.ink, marginTop: 14 },
  doneSub: { fontSize: 12.5, color: C.sub, marginTop: 6 },
  badge: {
    minWidth: 18, height: 18, borderRadius: 9, backgroundColor: C.coral,
    alignItems: 'center', justifyContent: 'center', paddingHorizontal: 5,
  },
  badgeT: { color: '#fff', fontSize: 10.5, fontWeight: '900' },
});
