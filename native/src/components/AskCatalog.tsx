...
const s = StyleSheet.create({
  ...
  sub: { fontSize: 12, color: C.sub, lineHeight: 18, marginTop: 6, marginBottom: 10 },
  searchRow: {
  ...
  catTitle: { fontSize: 14.5, fontWeight: '800', color: C.ink },
  catLead: { fontSize: 11.5, color: C.sub, marginTop: 2 },
  qRow: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    paddingVertical: 11, paddingHorizontal: 14,
    borderTopWidth: 0.5, borderTopColor: C.line,
  },
  qText: { flex: 1, fontSize: 13.5, color: C.ink },
  qArrow: { fontSize: 19, color: C.faint },
