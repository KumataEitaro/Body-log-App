...
const s = StyleSheet.create({
  ...
  emptyT: { fontSize: 13, color: C.faint },
  cmpBf: {
  ...
  label: { fontSize: 13, fontWeight: '700', color: C.sub, marginBottom: 4 },
  input: { backgroundColor: C.bg, borderWidth: 1, borderColor: C.line, borderRadius: 12, padding: 10, fontSize: 17, color: C.ink },
  ...
  addGhostT: { color: C.ink, fontSize: 13, fontWeight: '800' },
  dueT: { fontSize: 13, color: C.sub, marginTop: 8 },
  msg: { fontSize: 13, fontWeight: '600', color: C.sub, marginTop: 8 },
