...
export const NUTRIENT_DB: NutrientFood[] = [
  ...
  { id: 'chicken_thigh', name: { ja: '鶏もも肉（皮つき）', en: 'Chicken thigh (with skin)' }, aliases: ['鶏もも肉', '鶏もも', '鶏モモ', 'とりもも', '唐揚げ', 'から揚げ', 'からあげ', 'chicken thigh'], emoji: '🍗', cat: 'meat', unit: U('枚', 'piece', 250), serving: 100,
  ...
  { id: 'pork_leg', name: { ja: '豚もも肉（赤肉）', en: 'Pork leg (lean)' }, aliases: ['豚もも肉', '豚もも', '豚モモ肉', '豚モモ', 'pork leg'], emoji: '🐖', cat: 'meat', unit: U('枚', 'slice', 30), serving: 100,
  ...
  { id: 'beef_round', name: { ja: '牛もも肉（赤肉・輸入）', en: 'Beef round (lean)' }, aliases: ['牛もも肉', '牛もも', '牛モモ肉', '牛モモ', '赤身ステーキ', 'ローストビーフ', 'beef round'], emoji: '🥩', cat: 'meat', unit: U('枚', 'slice', 100), serving: 100,
