...
const s = themed(() => ({
  ...
  weekDone: { fontSize: 12.5, fontWeight: '700', color: C.successInk },
  ...
  shareBtnT: { fontSize: 13, fontWeight: '700', color: C.accentInk },
  ...
  sheetOn: { fontSize: 13, fontWeight: '800', color: C.accentInk, marginTop: 12, fontVariant: ['tabular-nums'] },
  ...
  sheetCtaT: { fontSize: 14.5, fontWeight: '800', color: C.accentInk },
}));
